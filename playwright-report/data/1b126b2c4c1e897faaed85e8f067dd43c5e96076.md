...
- Name: 학생 상담내역 >> 로그인 후 상담내역 페이지에서 본인 상담 데이터만 노출
- Location: /Users/kwon/Desktop/project/software-design/WEB/tests/consultation.spec.ts:4:3
...
Call log:
  - waiting for locator('input[name="username"]')
    ...
    at /Users/kwon/Desktop/project/software-design/WEB/tests/consultation.spec.ts:6:16
```
