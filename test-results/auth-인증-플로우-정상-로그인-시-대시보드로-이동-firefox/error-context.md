...
- Name: 인증 플로우 >> 정상 로그인 시 대시보드로 이동
- Location: /Users/kwon/Desktop/project/software-design/WEB/tests/auth.spec.ts:14:3
...
Call log:
  - waiting for locator('input[name="username"]')
    ...
    at /Users/kwon/Desktop/project/software-design/WEB/tests/auth.spec.ts:16:16
```
