...
- Name: 인증 플로우 >> 잘못된 정보로 로그인 시 에러 메시지 노출
- Location: /Users/kwon/Desktop/project/software-design/WEB/tests/auth.spec.ts:6:3
...
Call log:
  - waiting for locator('input[name="username"]')
    ...
    at /Users/kwon/Desktop/project/software-design/WEB/tests/auth.spec.ts:8:16
```
