...
- Name: 학생부(기록) 페이지 >> 탭 전환 시 각 데이터 정상 노출
- Location: /Users/kwon/Desktop/project/software-design/WEB/tests/records.spec.ts:14:3
...
Call log:
  - waiting for locator('input[name="username"]')
    ...
    at /Users/kwon/Desktop/project/software-design/WEB/tests/records.spec.ts:16:16
```
