    ...
    <SidebarContainer>
      ...
      <UserInfoSection isCollapsed={isCollapsed}>
        ...
        <UserRole isCollapsed={isCollapsed}>
          {isParent ? "학부모" : "학생"} {userInfo?.roleInfo || "2학년 3반 12번"}
        </UserRole>
      </UserInfoSection>
      ...
      <MenuGroup>
        ...
        >
          ...
          <MenuText isCollapsed={isCollapsed}>피드백 및 상담내역</MenuText>
        </MenuItem>
      </MenuGroup>
            ...
            <MenuIcon isCollapsed={isCollapsed}>
              ...
              >
                <path
                  ...
                  fill={
                    isActive("/parent/teacher-contact")
                      ? colors.primary.main
                      : colors.text.secondary
                  }
                />
